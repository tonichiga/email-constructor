            ...
            typeof (r = function () {
              ...
              function t(e) {
                var t,
                  ...
                  a = i.substring(0, n).split(".");
                return a.push(i.substring(n + 1)), a;
              }
              function r(e) {
              ...
              function n(e, n) {
                ...
                for (
                  var a = t(e), s = t(n), o = 0;
                  o < Math.max(a.length - 1, s.length - 1);
                  o++
                ) {
  ...
  (Window.prototype.forceJURL = !1),
        ...
        e: for (; (e[p - 1] != a || 0 == p) && !this._isInvalid; ) {
          ...
          switch (v) {
            case "scheme start":
              ...
              (y += b.toLowerCase()), (v = "scheme");
              break;
            case "scheme":
              if (b && o.test(b)) y += b.toLowerCase();
              else {
                if (":" != b) {
                  if (t) {
                    if (a == b) break e;
            ...
            case "authority first slash":
              if ("/" != b) {
                l("Expected '/', got: " + b), (v = "authority ignore slashes");
                continue;
              }
              v = "authority second slash";
              break;
            case "authority second slash":
              if (((v = "authority ignore slashes"), "/" != b)) {
                l("Expected '/', got: " + b);
                continue;
              }
              break;
            ...
            case "file host":
              if (a == b || "/" == b || "\\" == b || "?" == b || "#" == b) {
                2 != y.length || !s.test(y[0]) || (":" != y[1] && "|" != y[1])
                  ? (0 == y.length ||
                      ((this._host = h.call(this, y)), (y = "")),
            ...
            case "port":
              if (/[0-9]/.test(b)) y += b;
                ...
                if (
                  ...
                  if ("" != y) {
                    var j = parseInt(y, 10);
                    j != i[this._scheme] && (this._port = j + ""), (y = "");
                  }
                  if (t) break e;
                  v = "relative path start";
                  continue;
    ...
    (function () {
      ...
      function n(t, r) {
        ...
        u(t) && l.push(o);
        try {
          (Array.isArray(t) || (t && "object" === i(t))) &&
            Object.entries(t).forEach(function (t) {
              var r = e(t, 2),
                i = r[0];
              n(r[1], u, { _path: o.concat(i) }).forEach(function (e) {
                return l.push(e);
              });
            });
        } catch (e) {
              ...
              },
              {
                ...
                value: function (e, t, r) {
                  ...
                  (this.callbacks[i] = r),
                    this.postMessage(
                      e,
                      Object.assign({ frameId: this.id, callbackId: i }, t)
                    );
                },
              },
              {
      ...
      function v(e) {
        if (e) return Object.assign({}, e, !!e.attrs && { attrs: d(e.attrs) });
      }
      function p(e) {
        return v(e);
      }
            ...
            (i = [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  var i,
                    n = e.version || "1.5.10",
                    a = "".concat(r.p).concat("", "/editor.html"),
                    s = !1 === e.render ? "".concat(a, "?norender=true") : a;
                  ((i = n).startsWith("dev") || i.startsWith("qa")
                    ? 1
                    : r(9051)(i, "1.0.57")) <= 0 &&
                ...
                value: function (e) {
                  ...
                  e.excludeTools && (i.excludeTools = e.excludeTools),
                    ...
                    e.linkTypesSharedConfig &&
                      (i.linkTypesSharedConfig = v(e.linkTypesSharedConfig)),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  null === (t = this.frame) ||
                    void 0 === t ||
                    t.postMessage("setLinkTypes", { linkTypes: y(e) });
                },
              },
              {
      ...
      var E = (function (e) {
          ...
          function s() {
            return I(this, s), a.apply(this, arguments);
          }
          return (
            (t = s),
            (r = [
